...
class User(UserMixin, AbstractBaseUser, PermissionsMixin, UserLastActivityMixin):
    ...
    active_organization = models.ForeignKey("organizations.Organization", null=True, on_delete=models.SET_NULL, related_name="active_users")

    allow_newsletters = models.BooleanField(_("allow newsletters"), null=True, default=None, help_text=_("Allow sending newsletters to user"))
