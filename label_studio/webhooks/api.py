...
class WebhookFilterSet(django_filters.FilterSet):
    project = django_filters.ModelChoiceFilter(field_name="project", queryset=project_models.Project.objects.all(), null_label="isnull")
...
class WebhookInfoAPI(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if organization_only is not None:
            ...
            result = {key: value for key, value in result.items() if value.get("organization-only", False) == organization_only}
