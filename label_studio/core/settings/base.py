...
# MEMBER_PERM = "core.api_permissions.MemberHasAnnotatorPermission"
...
DATA_MANAGER_FILTER_ALLOWLIST = list(set(get_env_list("DATA_MANAGER_FILTER_ALLOWLIST") + ["updated_by__active_organization"]))
